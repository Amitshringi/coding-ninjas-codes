...
// let ballDia = 50; // ball diamieter in pixles.
// const ballLimits = [
//   screenData[1] - ballDia - 1,
//   screenData[0] - ballDia - 1,
//   1,
//   1
// ];
...
//   ballY: ballLimits[2],
//   playerPos: playerRightLimit / 2,
//   update: function (ballX, ballY, playerPos) {
//     //to update all the gf properties at single call
//     this.ballX = ballX;
//     this.ballY = ballY;
//     this.playerPos = playerPos;
//   },
//   setView: function () {
//     // this will update the user screen view.
//     player1.style.left = this.playerPos + "px";
//     player2.style.left = this.playerPos + "px";
//     ball.style.left = this.ballX + "px";
//     ball.style.bottom = this.ballY + "px";
...
//   // it will check whether ball touching the boundry and make related calls.
//   if (
//     gf.ballX + ballStep / 2 > ballLimits[1] ||
//     gf.ballX - ballStep / 2 < ballLimits[3]
//   ) {
//     slope *= -1;
//   }
//   if (gf.ballY + 20 > ballLimits[0]) {
//     if (
//       gf.ballX >= gf.playerPos - ballDia / 2 &&
//       gf.ballX <= gf.playerPos + playerWidth - ballDia / 2
//     ) {
//       console.log("play is safe", score);
//       score += 50;
//       slope *= -1;
...
//   // console.log("movePlayer", gf.playerPos,playerStep);
//   if (
//     gf.playerPos + playerStep >= playerLeftLimit &&
//     gf.playerPos + playerStep < playerRightLimit
//   ) {
//     gf.playerPos += playerStep;
//   } else if (gf.playerPos + playerStep <= playerRightLimit)
//     gf.playerPos = playerLeftLimit;
//   else if (gf.playerPos) gf.playerPos = playerRightLimit;
//   if (gf.playerPos !== check) gf.setView();
// }
...
// function handleKeypress(e) {
//   // var pressvalue = e.keyCode;
//   if (e.keyCode === 39) movePlayer(playerStep);
//   // bar move right by right arrow
//   else if (e.keyCode === 37) movePlayer(-1 * playerStep);
//   // bar move left by left arrow
//   else if (e.keyCode === 13 && !isGameRunning) {
//     // game will start
//     isGameRunning = true;
//     message.classList.add("hide-message"); // hide the message from the game.
//     console.log("this is start");
...
//   initailState();
//   console.log(window);
//   console.log(window.hasOwnProperty("highScore"));
//   if (!window.hasOwnProperty("highScore")) {
//     localStorage.setItem("highScore", score);
//     message.innerHTML =
//         "Hey! Hey!  you set the new <br>High score to -- " + score;
//       localStorage.highScore = score;
//        message.innerHTML =
//         "Hey try again <br> your score - " +
//         score +
//         " <br>High score - " +
...
//     if (!window.hasOwnProperty("highScore")) {
//       message.innerHTML =
//         "You are the first player <br>Press 'ENTER' to start game";
